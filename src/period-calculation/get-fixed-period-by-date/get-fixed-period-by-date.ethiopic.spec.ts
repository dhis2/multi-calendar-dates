...
describe('Ethiopic Calendar period by date calculation', () => {
    ...
    describe('monthly periods', () => {
        ...
        // @TODO(13th month):
        it.skip('should return "2013NovemberS1" for period type "SIXMONTHLYNOV" on "2014-01-01"', () => {
            const actual = getFixedPeriodByDate({
        ...
        // @TODO(13th month):
        it.skip('should return "2014NovemberS1" for period type "SIXMONTHLYNOV" on "2014-11-01"', () => {
            const actual = getFixedPeriodByDate({
                periodType: FIXED_PERIOD_TYPES.SIXMONTHLYNOV,
                date: '2014-11-01',
                calendar: 'ethiopic',
